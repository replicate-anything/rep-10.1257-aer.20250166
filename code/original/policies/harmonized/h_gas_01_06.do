...
global color_group5_`1' = 14
	...
	global `1'_ep = "N"
	global `1'_name "Gasoline Tax (Price Elasticity from Hughes et al. 2008 (2001–2006 Estimate))"
...
global note_`1' = `"Publication: Hughes et al. 2008 (2001–2006 Estimate)" "Global Assumptions: ${scc_ind_name}, ${dr_ind_name}" "Description: Gasoline Price of $`r(consumer_price_return)' (`dollar_year' dollars). `cc_note_gas_taxes' "'
