...
*https://www.sciencedirect.com/science/article/pii/S0140988309001856
*/
...
global `1'_ep = "N"
global `1'_name "Gasoline Tax (Price Elasticity from Park and Zhao 2010)"
...
global note_`1' = `"Publication: Park and Zhao 2010" "Global Assumptions: ${scc_ind_name}, ${dr_ind_name}" "Description: Gasoline Price of $`r(consumer_price_return)' (`dollar_year' dollars). `cc_note_gas_taxes' "'
