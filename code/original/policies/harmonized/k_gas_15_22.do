...
/* Kilian, Lutz, and Xiaoqing Zhou. (Elasticity for January 2015 through March 2022)
"Heterogeneity in the Pass-Through from Oil to Gasoline: A New Instrument for Estimating the Price Elasticity of Gasoline."
...
global wtp_comps_`1' wtp_cons wtp_soc_g wtp_soc_l_po wtp_soc_l_dr wtp_soc_rbd env_cost_wtp cost_wtp  wtp_prod_s wtp_prod_u WTP 

global wtp_comps_`1'_commas "wtp_cons", "wtp_soc_g", "wtp_soc_l_po", "wtp_soc_l_dr", "wtp_soc_rbd", "env_cost_wtp", "cost_wtp", "wtp_prod_s"
...
global `1'_xlab 1 "Transfer" 2 `""Global" "Env""' 3 `""Local" "Env""' 4 `" "Driving" "' 5 "Rebound" 6 `""Dynamic" "Env""' 7 `""Dynamic" "Price""' 8 `""Gasoline" "Producers" "' 9 `"Utilities"' 10 `""Total" "WTP""' 12 `""Program" "Cost""' 13 `"Taxes"' 14 `" "Subsidies" "' 15 `" "Climate" "FE" "' 16 `""Govt" "Cost""'
...
global color_group5_`1' = 15
	...
	global `1'_ep = "N"
	global `1'_name "Gasoline Tax (Price Elasticity from Kilian and Zhou 2023 (2015–2022 Estimate))"
...
global note_`1' = `"Publication: Kilian and Zhou 2023 (2015–2022 Estimate)" "Global Assumptions: ${scc_ind_name}, ${dr_ind_name}" "Description: Gasoline Price of $`r(consumer_price_return)' (`dollar_year' dollars). `cc_note_gas_taxes' "'
