...
THALES A. P., SVEN WUNDER, ERIN O. SILLS, JAN BÖRNER, SAMI W. RIFAI, ALEXANDRA N. NEIDERMEIER, GABRIEL P. FREY, AND ANDREAS KONTOLEON 
...
****************************************************
	...
	****************************************************
	local impact = 0.07 // even though 8 out of 26 were marginal, they led to less reductions in emissions than promised. The true percent of additionality was 7%
	
	local prop_marginal = `impact' // 8 out of the 26 projects were marginal
	
	local prop_infra = 1 - `prop_marginal'
	
	local subsidy = 4.7 * (${cpi_`dollar_year'}/${cpi_2021}) // estimate from: https://www.un-redd.org/sites/default/files/2022-11/Forest%20carbon%20pricing%20brief%20-%20FINAL.pdf
...
local global_pollutants = (${sc_CO2_2020} * `impact') * (${cpi_`dollar_year'} / ${cpi_${sc_dollar_year}})
