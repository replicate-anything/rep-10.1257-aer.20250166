...
global color_group5_`1' = 14
	...
	global `1'_ep = "N"
	global `1'_name "Gasoline Tax (Price Elasticity from Manzan and Zerom 2010)"
...
global note_`1' = `"Publication: Manzan and Zerom 2010" "Global Assumptions: ${scc_ind_name}, ${dr_ind_name}" "Description: Gasoline Price of $`r(consumer_price_return)' (`dollar_year' dollars). `cc_note_gas_taxes' "'
