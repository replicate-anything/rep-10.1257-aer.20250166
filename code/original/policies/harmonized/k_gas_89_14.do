...
/* Kilian, Lutz, and Xiaoqing Zhou. (Elasticity for January 1989 through December 2014)
...
global color_group5_`1' = 14
	...
	global `1'_ep = "N"
	global `1'_name "Gasoline Tax (Price Elasticity from Kilian and Zhou 2023 (1989–2014 Estimate))"
...
global note_`1' = `"Publication: Kilian and Zhou 2023 (1989–2014 Estimate)" "Global Assumptions: ${scc_ind_name}, ${dr_ind_name}" "Description: Gasoline Price of $`r(consumer_price_return)' (`dollar_year' dollars). `cc_note_gas_taxes' "'
