...
* https://www.sciencedirect.com/science/article/pii/S0047272706001162
*/
...
global color_group5_`1' = 14
	...
	global `1'_ep = "N"
	global `1'_name "Gasoline Tax (Price Elasticity from West and Williams 2007)"
...
global note_`1' = `"Publication: West and Williams 2007" "Global Assumptions: ${scc_ind_name}, ${dr_ind_name}" "Description: Gasoline Price of $`r(consumer_price_return)' (`dollar_year' dollars). `cc_note_gas_taxes' "'
